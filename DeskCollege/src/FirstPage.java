...
String txtdata;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select option", "Delhi Public School", "Others" }));
        ...
        jLabel4.setText("Enter School Name(In case of Others)");

        jTextField2.setBackground(new java.awt.Color(153, 255, 102));
        ...
        jLabel2.setText("Select School Name");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         String a=jComboBox1.getSelectedItem().toString();
       if(a.equals("Select option"))
       {
       JOptionPane.showMessageDialog(rootPane, "please select a option");
       }
       else if(jComboBox1.getSelectedItem().equals("Delhi Public School"))
       {
            try{ 
           
            String clg_name="Delhi Public School";
            Class.forName("com.mysql.jdbc.Driver");
            java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/admindb","root","rootroot");
            java.sql.Statement st=con.createStatement();
            st.executeUpdate("insert into college_name values('"+clg_name+"')");  
            }catch(Exception e)
             {
        ...
        new NewUser().show();
          ...
          try{ 
             ...
             String clg_name=jTextField2.getText();
            Class.forName("com.mysql.jdbc.Driver");
            java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/admindb","root","rootroot");
            java.sql.Statement st=con.createStatement();
            st.executeUpdate("insert into college_name values('"+clg_name+"')");  
